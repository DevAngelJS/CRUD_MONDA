                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="titulo_{{ $libro->id }}" name="titulo" placeholder="Ingrese el título del libro" value="{{ $libro->titulo }}">
                                    </div>
                                    @error('titulo')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="autor_{{ $libro->id }}" name="autor" placeholder="Ingrese el autor del libro" value="{{ $libro->autor }}">
                                    </div>
                                    @error('autor')
                                        <div class="alert text-danger p-0 m-0"><b>{{ 'Este campo es obligatorio.' }}</b></div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text inline-block"><i class="fas fa-calendar"></i></span>
                                        </div>
                                        <input type="date" class="form-control" id="año_publicacion_{{ $libro->id }}" name="año_publicacion" value="{{ $libro->año_publicacion }}">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="genero_{{ $libro->id }}" name="genero" placeholder="Ingrese el genero del libro" value="{{ $libro->genero }}">
                                    </div>
                                    @error('genero')
                                        <div class="alert text-danger p-0 m-0"><b>{{ 'Este campo es obligatorio.' }}</b></div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text inline-block"><i class="fas fa-language"></i></span>
                                        </div>
                                        <select name="idioma" id="idioma_{{ $libro->id }}" class="form-control">
                                            ...
                                            @foreach (['Español','Inglés','Francés','Alemán','Italiano','Portugués','Chino','Japonés','Ruso','Árabe'] as $opt)
                                                <option value="{{ $opt }}" {{ old('idioma', $libro->idioma) == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('idioma')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" id="cantidad_stock_{{ $libro->id }}" name="cantidad_stock" placeholder="Ingrese la cantidad en stock del libro" value="{{ $libro->cantidad_stock }}">
                                    </div>
