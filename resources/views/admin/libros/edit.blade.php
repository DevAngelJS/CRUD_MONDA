                ...
                @if (isset($id))
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/libros') }}" class="btn btn-tool">
                    ...
                    <div class="card-body" style="display: block;">
                        <form action="{{ route('admin.libros.update', $id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="form-group" style="text-align: right;">
                                <a href="{{ url('admin/libros') }}" class="btn btn-danger">Cancelar</a>
